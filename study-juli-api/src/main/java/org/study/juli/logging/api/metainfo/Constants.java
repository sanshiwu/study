...
public final class Constants {
  ...
  public static final String DEFAULT_HANDLERS_SINGLE =
      "org.study.juli.logging.core.handler.FileHandler,org.study.juli.logging.core.handler.ConsoleHandler";
  /** 日志消息中有多个大括号对. */
  public static final String BRACE = "{}";
  /** . */
  public static final String FORMATTER =
      "org.study.juli.logging.core.formatter.StudyJuliMessageTextFormatter";
  /** . */
  public static final String FILTER = "org.study.juli.logging.core.filter.StudyJuliFilter";
  /** . */
  public static final String FORMATTER_NAME =
      "org.study.juli.logging.core.handler.ConsoleHandler.formatter";
  /** . */
  ...
  public static final String STUDY_JULI_LOG_MANAGER =
      "org.study.juli.logging.core.manager.StudyJuliLogManager";
  /** . */
