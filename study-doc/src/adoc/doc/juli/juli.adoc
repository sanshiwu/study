...
.SPI.
----
include::{docdir}/study-examples/study-juli-examples/src/main/resources/META-INF/services/org.study.juli.logging.spi.Log[]
----
...
[source,properties]
----
include::{docdir}/study-examples/study-juli-spi-examples/src/main/resources/META-INF/services/org.study.juli.logging.spi.Log[]
----
...
.Log.
----
include::{docdir}/study-juli/src/main/java/org/study/juli/logging/spi/Log.java[]
----
