...
* More refined processing log. For example, Handler condition,Custom filter.
...
This is not an elegant solution. But it's very useful.
...
The JSON format is provided by default. Other formats are not supported.
